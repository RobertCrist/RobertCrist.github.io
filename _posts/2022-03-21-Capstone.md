...
## Reaching and Exploring the Contents of a Jar
 ---
 
 The first major task I was assigned was to get the octopus arms to be able to reach inside a jar and explore the inner space. Due to my initial lack of experience in both AI and Unity, I started out by creating a simple AI
